...
const TestExerciseCreationCard: React.FC<ExerciseCreationCardProps> = ({
  exerciseIndex,
  exercise,
}) => {
            ...
            {exercise.sets?.map((item, index) => (
              ...
              >
                <View style={styles.setCard}>
                  ...
                  >
                    <Text style={[styles.proprtyText, { flex: item.failure.toString() ==='true' ? 0 : 1 }]}>
                      Rep Range
                    </Text>
                    {item.failure.toString() === 'false' ? (
                      <>
...
export default TestExerciseCreationCard;
